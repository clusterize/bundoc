...
export type Manifest = {
  ...
  /** Optional template applied to `document.title` on every navigation. `%s` is the page title. */
...
export function emitManifestModule(opts: {
  ...
  const exportable = {
    ...
    ...(manifest.titleTemplate !== undefined
...
export const titleTemplate = manifest.titleTemplate;
`;
}
